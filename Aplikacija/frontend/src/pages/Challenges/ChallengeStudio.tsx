...
function ChallengeStudio() {
    ...
    return (
        <div className="challenge-studio">
            ...
            <div className="challenge-studio-filters">
                <button
                    className='challenge-studio-add'
                    onClick={() => {
                        navigate("/moderator/new-challenge")
                    }}
                >Add New Challenge</button>
                <div className="challenge-studio-right">
                    <SearchBar 
                        label='Challenges'
            ...
            <DataTable 
                className='challenge-studio-table'
