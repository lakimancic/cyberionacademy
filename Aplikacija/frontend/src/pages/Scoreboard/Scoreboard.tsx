    ...
    return (
        <div className="scoreboard">
            ...
            <div className="scoreboard-tabs">
                <div className="scoreboard-tab" onClick={() => changeTab(0)}>Users Ranking</div>
                <div className="scoreboard-tab" onClick={() => changeTab(1)}>Countries Ranking</div>
                <div 
            ...
            <div className="scoreboard-content">
                ...
                />}
                {tab === 1 && !currentCountry && <DataTable 
                    data={countries.map(country => {
                        return {
                            ranking: <div className='score-ranking'>
                                {country.rankNum <= 3 ? <img src={thropies[country.rankNum - 1]} /> : `#${country.rankNum}`}
                            </div>,
                            country: <div className='score-user'>
                                <Avatar src={`https://flagcdn.com/w160/${country.country}.png`} />
                                <span>{(countriesMap as any)[country.country] ?? 'Unknown'}</span>
                            </div>,
                            users: <div className="score-users">
                ...
                />}
                {tab === 1 && currentCountry && <div className='score-country-con'>
                    <IoMdArrowRoundBack className='admin-back' onClick={() => setCurrentCountry(null)} />
                    <div className="score-country">
                        <Avatar src={`https://flagcdn.com/w160/${currentCountry.country}.png`} />
                        <div className="score-country-info">
                            <h2>{(countriesMap as any)[currentCountry.country] ?? 'Unknown'}</h2>
